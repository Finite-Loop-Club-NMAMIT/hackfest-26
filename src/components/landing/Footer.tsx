...
const social = [
    {
        ...
        icon: <Instagram className="text-cyan-400 hover:text-cyan-300 w-6 h-6 transition-colors" />,
        name: "Instagram",
    },
    {
        link: "mailto:admin@hackfest.dev",
        icon: <Mail className="text-cyan-400 hover:text-cyan-300 w-6 h-6 transition-colors" />,
        name: "E-mail",
    },
    {
        link: "https://discord.gg/d9hQV8Hcv6",
        // Lucide doesn't have a Discord icon, using Globe as generic or could use SVG if critical
        // Or I can inline the SVG for Discord if needed, but for now Globe is a placeholder or I can try to find a better one
        // Let's use a custom SVG for Discord to keep it nice
        icon: (
            <svg
            ...
            <div className="flex h-full flex-col items-center justify-evenly space-y-12 p-4 py-8 lg:flex-row relative">
                ...
                <div className="flex flex-col items-center gap-8 z-10">
                    ...
                    <div className="flex flex-col items-center gap-4 md:gap-4">
                        <p className="text-base font-normal text-cyan-100/70">Connect with us:</p>
                ...
                <div className="flex flex-col items-center gap-8 z-10">
                    <div className="flex flex-col items-center justify-center gap-10 md:flex-row">
                        ...
                        <div className="flex flex-col gap-2 text-center text-cyan-100/80">
                            <h1 className="text-lg font-semibold text-cyan-400">NMAM Institute of Technology, Nitte</h1>
                            <p className="text-sm opacity-70">Karkala, Udupi District, Karnataka</p>
                        </div>
                    </div>
                    <p className="text-center text-base font-normal text-cyan-100/60">
                        Interested to sponsor? Let us know{" "}
                        <Link href="mailto:sponsor@hackfest.dev" className="text-cyan-400 underline hover:text-cyan-300 transition-colors">
