    ...
    return (
        <div className="w-full max-w-7xl mx-auto py-12 md:py-16 flex flex-col items-center">
            ...
            >
                ...
                <h3 className="text-3xl font-pirate text-cyan-100 mb-4">Send a Raven</h3>
                <p className="text-cyan-200/70 mb-8 font-crimson text-xl max-w-lg">
                    Have queries about the voyage? Reach out to us directly. We are always listening to the waves.
                </p>

                <div className="flex flex-col md:flex-row gap-8 items-center justify-center relative z-10">
                    <div className="flex flex-col items-center gap-2">
                        <span className="text-cyan-200/60 font-crimson uppercase tracking-widest text-sm font-semibold">General Inquiries</span>
                    ...
                    <div className="flex flex-col items-center gap-2">
                        <span className="text-cyan-200/60 font-crimson uppercase tracking-widest text-sm font-semibold">For Sponsors</span>
                        <div className="relative group">
                            <div className="absolute inset-0 bg-cyan-400/20 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                            <a
...
function OrganizerCard({ organizer, index }: { organizer: any, index: number }) {
    return (
        <motion.div
        ...
        >
            <div className="text-center z-10">
                <h3 className="font-pirate text-3xl text-cyan-100 tracking-wide mb-2 group-hover:text-cyan-300 transition-colors">{organizer.name}</h3>
                <p className="font-crimson text-cyan-400/80 font-bold tracking-widest text-sm uppercase mb-6">{organizer.role}</p>
