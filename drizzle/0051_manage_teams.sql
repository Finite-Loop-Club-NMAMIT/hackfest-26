CREATE TYPE "public"."team_committee" AS ENUM('Organising Committee', 'Technical Committee', 'Sponsorship Committee', 'Social Media & Media Committee', 'Digital Committee', 'Documentation Committee', 'Publicity Committee', 'Operations Committee', 'Event Management Committee', 'Crew Committee');
